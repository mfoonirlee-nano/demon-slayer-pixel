...
export const PAUSE_PANEL_TITLE_TOP = 28;
export const PAUSE_TAB_INSET_X = 48;
export const PAUSE_PANEL_INSET_X = 48;
export const PAUSE_PANEL_CONTENT_TOP = 52;
export const PAUSE_PANEL_CONTENT_BOTTOM = 44;
export const PAUSE_TAB_W = 126;
export const PAUSE_TAB_H = 42;
export const PAUSE_TAB_GAP = 4;
export const PAUSE_TAB_BODY_GAP = 6;
export const PAUSE_CURRENT_COLUMN_W = 160;
export const PAUSE_CHOICES_COLUMN_W = 352;
export const PAUSE_CURRENT_FRAME_SIZE = 44;
export const PAUSE_CHOICE_FRAME_SIZE = 54;
export const PAUSE_CURRENT_ICON_SIZE = 28;
export const PAUSE_CHOICE_ICON_SIZE = 34;
export const PAUSE_CURRENT_BADGE_SIZE = 14;
export const PAUSE_CHOICE_BADGE_SIZE = 15;
export const PAUSE_ICON_OFFSET_Y = 2;
export const PAUSE_CURRENT_ROW_GAP = 6;
export const PAUSE_CHOICE_GRID_COLUMNS = 5;
export const PAUSE_CHOICE_GRID_GAP = 6;
export const PAUSE_CHOICE_GRID_COLUMN_W = 62;
export const PAUSE_COLUMN_GAP = 14;
export const PAUSE_INFO_INSET_X = 8;
export const PAUSE_INFO_ROW_GAP = 6;
export const PAUSE_INFO_COLUMN_GAP = 8;
export const PAUSE_SETTINGS_GAP = 10;
export const PAUSE_DETAIL_PANEL_H = 54;
