...
export const PAUSE_PANEL_W = 1184;
export const PAUSE_PANEL_H = 514;
export const PAUSE_TAB_INSET_X = 42;
export const PAUSE_PANEL_INSET_X = 160;
export const PAUSE_PANEL_CONTENT_TOP = 112;
export const PAUSE_PANEL_CONTENT_BOTTOM = 160;
export const PAUSE_TAB_W = 126;
export const PAUSE_TAB_H = 42;
export const PAUSE_TAB_GAP = 4;
export const PAUSE_TAB_BODY_GAP = 8;
...
export const PAUSE_CHOICE_GRID_COLUMNS = 4;
export const PAUSE_CHOICE_GRID_GAP = 8;
export const PAUSE_CHOICE_GRID_COLUMN_W = 78;
