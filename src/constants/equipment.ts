...
export const RISK_TALISMAN_SKILL_REGEN_PER_SECOND: Record<EquipmentTier, number> = {
  common: 2,
  fine: 3,
  awakened: 4,
};
export const RISK_TALISMAN_ULTIMATE_GAIN = 8;
export const RISK_PAIR_SPEED_MULTIPLIER = 1.15;
export const RISK_FULL_SPEED_MULTIPLIER = 1.3;
export const RISK_FULL_SHIELD_COOLDOWN_SECONDS = 5;
export const RISK_FULL_SHIELD_COOLDOWN_FRAMES = (
  RISK_FULL_SHIELD_COOLDOWN_SECONDS * EQUIPMENT_FRAMES_PER_SECOND
);
