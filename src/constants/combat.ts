...
const BOSS_BODY_DRAW_SCALE_NUMERATOR = 4;
const BOSS_BODY_DRAW_SCALE_DENOMINATOR = 3;
export const BOSS_BODY_DRAW_SCALE = BOSS_BODY_DRAW_SCALE_NUMERATOR / BOSS_BODY_DRAW_SCALE_DENOMINATOR;
...
export const PLAYER_COMBAT = {
  ...
  ultimateRadius: 360,
  ultimateCastFrames: 30,
  ultimateCastFrameDuration: 5,
...
export const BOSS_CONFIG = {
  ...
  rushWindupFrames: 24,
  rushWindupPhaseReduction: 2,
  rushWindupMinFrames: 18,
  rushFrames: 26,
  rushVelocityBase: 6,
  retreatFrames: 28,
  retreatVelocity: 3.2,
  ...
  animSeedMax: 80,
  baseAnimSpeed: 9,
  bodyDrawScale: BOSS_BODY_DRAW_SCALE,
  drawOffsetX: 0,
  drawOffsetY: 0,
  drawW: 176,
  drawH: 208,
