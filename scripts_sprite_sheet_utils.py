...
SPRITE_SHEET_SPECS = {
    ...
    "skills/line_projectile/skill.png": dict(frame_w=800, frame_h=420, count=5, padding=12, anchor_y="center"),
    "skills/line_projectile/effect.png": dict(frame_w=250, frame_h=150, count=7, padding=6, anchor_y="center"),
    "skills/close_arc/skill.png": dict(frame_w=500, frame_h=500, count=6, padding=12, anchor_y="center"),
    "skills/close_arc/effect.png": dict(frame_w=380, frame_h=450, count=6, padding=10, anchor_y="center"),
    "skills/guard_counter/skill.png": dict(frame_w=540, frame_h=470, count=5, padding=12, anchor_y="center"),
    "skills/guard_counter/effect.png": dict(frame_w=400, frame_h=300, count=6, padding=10, anchor_y="center"),
