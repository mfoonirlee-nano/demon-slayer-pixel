...
SPRITE_SHEET_SPECS = {
    ...
    "enemies/enemy_1.png": dict(frame_w=287, frame_h=282, count=4, padding=8, anchor_y="bottom"),
    "enemies/enemy_2.png": dict(frame_w=314, frame_h=145, count=4, padding=6, anchor_y="bottom"),
    "enemies/enemy_3.png": dict(frame_w=233, frame_h=250, count=4, padding=8, anchor_y="bottom"),
    "enemies/enemy_4.png": dict(frame_w=288, frame_h=360, count=4, padding=10, anchor_y="bottom"),
    "enemies/enemy_5.png": dict(frame_w=320, frame_h=360, count=4, padding=10, anchor_y="bottom"),
    "enemies/enemy_6.png": dict(frame_w=314, frame_h=145, count=4, padding=6, anchor_y="bottom"),
    "enemies/boss.png": dict(frame_w=350, frame_h=419, count=4, padding=12, anchor_y="bottom"),
    "enemies/boss_skill1.png": dict(frame_w=400, frame_h=400, count=6, padding=12, anchor_y="center"),
    "enemies/boss_skill1_effect.png": dict(frame_w=400, frame_h=350, count=6, padding=10, anchor_y="center"),
