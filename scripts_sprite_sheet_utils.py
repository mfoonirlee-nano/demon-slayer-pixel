...
SPRITE_SHEET_SPECS = {
    ...
    "enemies/brute/brute_advance.png": dict(frame_w=314, frame_h=145, count=6, padding=6, anchor_y="bottom"),
    "enemies/brute/brute_brace.png": dict(frame_w=314, frame_h=145, count=4, padding=6, anchor_y="bottom"),
    "enemies/brute/brute_stomp.png": dict(frame_w=314, frame_h=145, count=5, padding=6, anchor_y="bottom"),
    "enemies/brute/brute_recover.png": dict(frame_w=314, frame_h=145, count=3, padding=6, anchor_y="bottom"),
    "enemies/boss/boss.png": dict(frame_w=350, frame_h=419, count=4, padding=12, anchor_y="bottom"),
    "enemies/boss/boss_skill1.png": dict(frame_w=400, frame_h=400, count=6, padding=12, anchor_y="center"),
    "enemies/boss/boss_skill1_effect.png": dict(frame_w=400, frame_h=350, count=6, padding=10, anchor_y="center"),
