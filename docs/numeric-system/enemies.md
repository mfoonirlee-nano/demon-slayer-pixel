...
- 没有按幕常规敌人池、轮换池或生成预算。
- `burrower`、`splitter`、`warden` 没有运行时实现。
...
- 当前 `ENEMY_SHEETS` 包含 `chaser.png`、`crawler.png`、`runner_approach.png`、`caster_move.png`、`duelist.png`、`brute_advance.png`、`binder_move.png`、`glider_hover.png`、`leaper_stalk.png` 九个表。
