...
计划中的高台秘藏使用第三个独立队列，计划顺序为 Boss 装备选择 > 高台秘藏选择 > 经验升级选择。它只提供明确的一件新装备或同槽替换，不提供同 ID 品质提升，也不会再打开第二层装备三选一；完整边界见 [high-platform-treasure.md](high-platform-treasure.md)。
