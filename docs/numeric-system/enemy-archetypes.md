...
普通敌人可优先在右侧屏幕外平台出生。第 4 幕起，常规刷怪有小概率从当前可见的近景遮挡物后出生；候选遮挡物必须宽高都大于敌人碰撞体，中心点落在屏幕内，并且不会与玩家横向碰撞体立即重叠。命中后会短暂重绘该遮挡物覆盖出生敌人，未命中遮挡物规则时仍回退到原有屏幕边缘或平台出生。Boss 召唤和 debug spawn 不使用近景遮挡物出生。
