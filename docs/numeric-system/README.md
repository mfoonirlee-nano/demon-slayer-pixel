...
- 经验系统见 [progression.md](progression.md)，当前只记录待实现设计：局内 XP、角色等级、普通技能等级、大招强化等级、升级三选一、升级暂停和选择输入。
...
| [progression.md](progression.md) | 目标设计，未实现 | 经验、角色等级、普通技能等级、大招强化等级、升级三选一和局内成长 |
