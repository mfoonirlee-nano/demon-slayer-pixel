...
- 玩家攻击气质来自“水之呼吸”：清亮、流动、带白色浪尖和蓝色卷线的英雄感。
- 敌人与 Boss 是原创妖鬼变体。音乐也应保持原创，不直接模仿任何现成动漫、电影或游戏配乐。
...
> 原创暗色日式妖鬼像素动作配乐。用尺八、篠笛、三味线、琵琶/筝、太鼓、木鱼、裂铃等日式音色建立山林夜战气质，再叠加少量 16-bit / FM synth / square lead / noise percussion，让它属于像素生存游戏，而不是纯影视配乐。

音乐需要保持三条线：

| 线索 | 音乐表现 | 用途 |
| --- | --- | --- |
| 玩家水流 | 清亮尺八、筝拨弦、square lead、上行五声音阶短句 | 技能、大招、胜利、反击窗口 |
| 妖鬼压迫 | 低太鼓、失谐 FM bass、刮弦、低音半音下行 | 敌潮、Boss 阶段、血月 |
...
| Motif | 设计 | 建议音色 |
| --- | --- | --- |
| 水之反击 | 4-5 个音的上行短句，结尾轻微回落，像浪花收束 | 尺八、筝、明亮 square lead、轻铃 |
| 血月 | 低音持续音 + 半音下行，偶尔出现低沉鼓击 | 低 taiko、FM bass、暗红色 pad |
| 妖鬼追击 | 重复 3 音 ostinato，第二拍或第四拍带切分 | 三味线低弦、木鱼、低合成器 |
| Boss 前摇 | 短暂停拍后单次强打，给读招空间 | 大太鼓、裂铃、刮弦 |
| 终幕换相 | 每个 Boss 元素只露 1 个音色，不同相按顺序进入 | 蛛丝高弦、骨片木击、镜片钟声、兽性低鼓、鬼灯火星、枯铃 |
...
Tempo: {tempo}. Mood: {mood}. Use short pentatonic motifs, minor mode, clear ostinato, and dynamic percussion that leaves space for sword hits and water skill SFX. {special_motif}
...
用途：标题页、开始菜单。让玩家一进来就看到“夜路、鸟居、血月、妖鬼将至”，但不要进入满强度战斗。
...
Tempo: 78 BPM. Mood: ominous, lonely, restrained, heroic under the surface. Introduce a clean 4-note rising water motif once every 16 bars, answered by a low blood moon drone. Keep the arrangement spacious and mysterious, not battle-heavy.
...
```text
Instrumental seamless loop for early-stage combat in an original 2D pixel action survival game. Moonlit Japanese mountain road, simple demon chasers crossing the screen, agile sword movement, water-breathing hero energy. Use shamisen ostinato, light taiko, wooden percussion, koto plucks, small 16-bit square lead accents, and a soft shakuhachi counter-melody.

Tempo: 104 BPM. Mood: tense but readable, agile, focused, adventurous. The main rhythm should feel like running across platforms at night. Add a clear rising water motif for heroic moments, but keep demon pressure light and sparse.
...
```text
Instrumental seamless loop for mid-stage combat in an original 2D pixel action survival game. Fast demon runners, duelists, and leaping ambushes pressure the player across platforms. Dark Japanese fantasy mixed with crisp 16-bit action energy: driving shamisen riffs, tighter taiko pattern, short shinobue cuts, FM bass pulses, square lead stabs, and dry wooden percussion.

Tempo: 118 BPM. Mood: urgent, agile, sharp, dangerous but still controllable. Use syncopated rhythms to suggest dash windups and sudden lunges. The heroic water motif should appear as brief bright answers after darker demon phrases.
...
### 5. Act 4+ Endless Battle - Full Demon Pool

用途：第四幕及无限挑战，全敌人池轮换，强度最高但仍要可循环长时间听。

```text
Instrumental seamless loop for high-intensity endless combat in an original 2D pixel action survival game. Full demon enemy pool, blood moon sky, fast platform survival, constant but readable threat. Hybrid Japanese dark fantasy and 16-bit arcade action: aggressive shamisen, layered taiko, tight wooden percussion, FM bass ostinato, square lead counter-rhythm, cracked bell hits, and short shakuhachi cries.

Tempo: 132 BPM. Mood: relentless, dangerous, focused, late-night survival. Use a repeating demon ostinato under a brighter water counter-motif. Add brief breakdowns every 32 bars so the loop can breathe before returning to full intensity.
...
```text
Short instrumental boss intro sting for an original 2D pixel action survival game. Dark Japanese fantasy, blood moon flash, demon reveal. Use one huge taiko hit, a cracked bell, scraped shamisen strings, low FM bass swell, and a short shakuhachi fall.
...
```text
Instrumental seamless boss battle loop for an original 2D pixel action survival game. Theme: spider-string demon hunting the player under a moonlit torii road. Use high tension string-like shamisen tremolo to suggest spider silk, sharp koto plucks like web cuts, low taiko chase rhythm, detuned FM bass, dry wooden clicks, and brief cracked bell accents.

Tempo: 138 BPM. Mood: predatory, tightening, agile, dangerous. The rhythm should feel like a web slowly closing: repeated high plucked motifs, sudden pauses before taiko strikes, and short bursts of 16-bit lead for projectile volleys. Add a bright water motif only as a small counterattack answer.
...
```text
Instrumental seamless boss battle loop for an original 2D pixel action survival game. Theme: mist-bone demon controlling the ground with white fog and bone spikes. Use breathy shakuhachi, low taiko pulses, dry bone-like wooden percussion, muted biwa plucks, cold FM bass drone, and thin 16-bit noise textures.

Tempo: 116 BPM with occasional half-time weight. Mood: suffocating, patient, eerie, tactical. Create delayed-impact tension: quiet fog sections, small warning clicks, then sudden bone-spike percussion bursts. Keep the melody sparse and cold, with a faint water motif trying to cut through the fog.
...
```text
Instrumental seamless boss battle loop for an original 2D pixel action survival game. Theme: fang-gale demon, a low beast-like hunter charging through the night wind. Use aggressive low shamisen riffs, fast taiko rolls, wooden clacks, short shinobue screams, FM bass growls, and 16-bit square lead slashes.
...
```text
Instrumental seamless boss battle loop for an original 2D pixel action survival game. Theme: dead-bell demon turning cracked bell rhythms into blades. Use a broken temple bell as the central motif, low taiko, sparse shamisen, dry wooden percussion, dark FM bass, and thin square lead blade accents.
...
```text
Short instrumental victory sting for an original 2D pixel action game. Bright water motif on shakuhachi and koto, one clean taiko hit, small 16-bit sparkle, night tension briefly clears.
