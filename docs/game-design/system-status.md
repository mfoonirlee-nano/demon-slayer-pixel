...
| 音效 | 23 个敌人 WAV 与 29 个玩家 WAV 已覆盖双方关键动作和技能生命周期；Web Audio tone 作为回退，主音量/音效音量已接入 | 继续补 Boss 采样、BGM 和 Boss 音乐 | 部分实现 | P4 | `src/game/audio.ts`、`src/game/audioSamples.ts`、`docs/music-direction.md` |
