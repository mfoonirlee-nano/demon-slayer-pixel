...
| 2 | 雾骨 Mist Bone | 基础 | 薄雾减速 + 骨刺封锁；P3 成列骨刺后锁向追击 | 解锁到 5，常规池 4，固定 `technique_intro` | 70-100s | 55-70% |
...
| 6 | 枯铃 Dead Bell | 基础 | 确定性单/双/组合节拍 + 声波/音刃 + 无接触伤害反击窗 | 解锁 12，常规池 8，随机 profile 补齐高阶机制 | 80-110s | 40-55% |
| 7 | 蛛弦·蚀醒 | 加强 | + 地面、空中与左右连续柱阵「千丝牢笼」 | 常规池 8，觉醒 profile shuffle cycle | 90-120s | 35-50% |
| 8 | 雾骨·蚀醒 | 加强 | + 局部浓雾遮蔽 + 由外向内延迟骨爆 + 守望者支援 | 常规池 8，觉醒 profile shuffle cycle | 90-120s | 30-45% |
